...
import { getItemData, newItem } from "./utils.js";
import { scoreboard } from "../../../management/ScoreboardManager/scoreboard.js";
...
Command.register({
    ...
    if (create.includes(args[0])) {
        ...
        if (scoreboard.get(player, "money") < Data.price) return player.tell(`§cYou need ${Data.price - scoreboard.get(player, "money")} more to buy this item`)
